...
- **שחרית מניין ראשון:** בשעה **`06:15`** (סליחות קצרות ומסתיימות לקראת 06:15; תפילת שחרית קצרה ללא מזמור לתודה, תחנון ואבינו מלכנו).
- **שחרית מניין שני:** בשעה **`07:10`**.
...
| **שחרית ערב יו״כ** | **`06:15`** / **`07:10`** | `06:15` / `07:10` | ללא מזמור לתודה, תחנון ואבינו מלכנו (סליחות קצרות מסתיימות לפני 06:15) |
