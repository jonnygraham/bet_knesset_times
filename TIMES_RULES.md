...
| **מנחה קטנה** | $\text{Shkia} - 40\text{ min}$, מעוגל מטה ל-5 דק׳ (40 עד 44 דק׳ לפני שקיעה) | בדיוק כמו שבת רגילה (e.g. שקיעה `18:50` $\rightarrow$ `18:10`) |
| **תשליך** | לאחר מנחה קטנה | **רק כאשר יום א׳ חל ביום חול** (אם יום א׳ שבת — נדחה ליום ב׳) |
| **ערבית יום ב׳ של ר״ה** | $\text{Shkia} + 20\text{ min}$ (**`19:10`**) | תפילת ליל שני של חג |
| **הכנות / הדלקת נרות ליום ב׳** | **צאת השבת / צאת הכוכבים** המדויק מ-2net | e.g. `19:27`. חל איסור מוחלט להכין מיום א׳ ליום ב׳ לפני זמן זה |
...
| **מנחה קטנה** | $\text{Shkia} - 40\text{ min}$, מעוגל מטה ל-5 דק׳ (40 עד 44 דק׳ לפני שקיעה) | e.g. שקיעה `18:49` $\rightarrow$ `18:05` (או `18:10`) |
| **תשליך** | לאחר מנחה קטנה | **נאמר ביום ב׳ כאשר יום א׳ של ר״ה חל בשבת** |
| **ערבית מוצאי חג** | **צאת הכוכבים / צאת החג** המדויק מ-2net | e.g. `19:17` (ולאחריה הבדלה וצאת החג) |
